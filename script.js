...
function tellJoke(joke) {
    console.log(joke);
    VoiceRSS.speech({
        key: '0953eb33a9674afabf2f3179b5b50601',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
async function getJokes() {
    const apiUrl = 'https://v2.jokeapi.dev/joke/Programming,Miscellaneous,Dark,Pun,Spooky,Christmas?blacklistFlags=racist';
    ...
    try {
        ...
        if (apiJokes.setup) {
            joke = `${apiJokes.setup} ... ${apiJokes.delivery}`;
        } else {
            joke = apiJokes.joke;
        }
        // Text-to-Speech
        ...
        // Catch errors
        console.log('Warning:', currentError);
    }
